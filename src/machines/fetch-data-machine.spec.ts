...
import { createDataMachine, DataContext, DataEvents, DataSchema } from './data-fetch-machine'

describe('fetchDataMachine', () => {
  let testMachine: Interpreter<DataContext<any>, DataSchema, DataEvents> | undefined = undefined
  let stateArray: StateValue[] = []
  const dataMachine = createDataMachine<string>('testMachine')
